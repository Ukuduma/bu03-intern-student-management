...
import com.viettel.intern.service.impl.StudentServiceImpl;
...
public class StudentController {
    ...
    public ResponseEntity<GeneralResponse<Object>> getAllCourses(@RequestParam(defaultValue = "0") int page,
                                                              @RequestParam(defaultValue = "5") int size,
                                                              @RequestParam(defaultValue = "name") String sortBy,
                                                              @RequestParam(defaultValue = "asc") String sortOrder,
                                                              @RequestParam(defaultValue = "") String keyword) {
        Page<CourseDTO> coursePage = studentServiceImpl.searchAndSortCourses(keyword, page, size, sortBy, sortOrder);
        return responseFactory.success(coursePage);
    }
}
